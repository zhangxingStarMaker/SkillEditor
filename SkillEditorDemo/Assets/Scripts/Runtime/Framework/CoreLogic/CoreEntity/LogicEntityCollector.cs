...
{
    // 管理根部的Scene
    public class LogicEntityCollector: Singleton<LogicEntityCollector>, ISingletonAwake
    {
        // 管理所有的Entity
        private readonly Dictionary<long, CoreEntity> allEntities = new();
        ...
        {
            this.allEntities.Add(coreEntity.InstanceId, coreEntity);
        }
        ...
        public CoreEntity Get(long instanceId)
        {
            CoreEntity component = null;
